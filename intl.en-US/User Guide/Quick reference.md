...
To guarantee proper operation of your ECS instance, please read the [ECS operation instructions](reseller.en-US/User Guide/Instructions on using ECS.md#) and [Limits](reseller.en-US/User Guide/Limitations.md#) sections carefully before using your instance.
...
You can [switch from Pay-As-You-Go to Subscription](../../../../reseller.en-US/Pricing/Limits.md#).
...
3.  [\(Linux\) Format and mount a data disk](../../../../reseller.en-US/Quick Start for Entry-Level Users/Step 4. Format a data disk/Format and mount data disks for Linux instances.md#) or [\(Windows\) Format a data disk](../../../../reseller.en-US/Quick Start for Entry-Level Users/Step 4. Format a data disk/Format a data disk for Windows instances.md#).
4.  [Create snapshots](reseller.en-US/User Guide/Snapshots/Create snapshots.md#) to back up data.
...
1.  Create a snapshot by using either of the following methods:
    -   [Create snapshots](reseller.en-US/User Guide/Snapshots/Create snapshots.md#).
...
-   [Create and import custom images stored on an on-premises server by using Packer](reseller.en-US/User Guide/Images/Open source tools/Create and import on-premise images by using Packer.md#)

You can also [export custom images](reseller.en-US/User Guide/Images/Export custom images.md#) to back up your environment and [delete custom images](reseller.en-US/User Guide/Images/Delete custom images.md#) when they are no longer required.
...
3.  [Add to or remove from a security group](reseller.en-US/User Guide/Instances/Add to or remove from a security group.md#)
...
2.  [Bind a SSH key pair](reseller.en-US/User Guide/Key pairs/Bind or unbind an SSH key pair.md#), or bind the SSH key pair after a Linux instance is created or when you [create an instance](../../../../reseller.en-US/Quick Start for Entry-Level Users/Step 2. Create an instance.md).
...
4.  [Unbind an SSH key pair](reseller.en-US/User Guide/Key pairs/Bind or unbind an SSH key pair.md).
5.  [Delete a SSH key pair](reseller.en-US/User Guide/Key pairs/Delete a SSH key pair.md#).
