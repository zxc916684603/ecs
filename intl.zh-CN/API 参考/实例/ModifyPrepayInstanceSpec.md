...
-   升级或者降低[预付费（包年包月）](../intl.zh-CN/产品定价/包年包月.md#)实例规格前，您可以通过[DescribeResourcesModification](intl.zh-CN/API 参考/地域/DescribeResourcesModification.md#)查询当前实例支持变配的实例规格。
...
|InstanceType|String|是|需要变配的目标实例规格。更多详情，请参阅[实例规格族](../intl.zh-CN/产品简介/实例规格族.md#)，也可以调用[DescribeInstanceTypes](intl.zh-CN/API 参考/实例/DescribeInstanceTypes.md#)接口获得最新的规格表。|
