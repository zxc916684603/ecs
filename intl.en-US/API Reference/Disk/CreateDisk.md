...
-   Creating a disk involves resource billing. Know the billing methods of ECS in advance. For more information, see [Pay-As-You-Go](../intl.en-US/Pricing/Pay-As-You-Go.md#) \(`PostPaid`\).

-   The `DeleteAutoSnapshot` attribute of the created disk is `true`, and automatic snapshots are deleted by default when you delete the data disk. You can use [ModifyDiskAttribute](intl.en-US/API Reference/Disk/ModifyDiskAttribute.md#) to modify this attribute.
