...
1.  下载并解压迁云工具，运行迁云工具中的client\_check脚本，检查待迁移UCloud云主机是否满足迁移条件。具体操作步骤如下：
    ...
    2.  运行以下命令解压缩迁云工具。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/65301/154872842738160_zh-CN.png)
    ...
    3.  运行以下命令查看待迁移Linux系统的型号，并将适用于该系统型号的迁云工具包解压缩。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/65301/154872842738161_zh-CN.png)
...
2.  配置迁移所需参数并运行迁云工具。具体操作步骤如下：
    ...
    4.  等待迁云工具运行完成。当运行迁云工具的界面上提示Go to Aliyun Finished!时，表示迁移完成。如下图所示。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/65301/154872842838196_zh-CN.png)
