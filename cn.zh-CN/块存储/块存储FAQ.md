...
手动快照不会被删除。自动快照是否会被删除，取决于您是否设置了**自动快照随磁盘释放**。详情请参见[设置自动快照随云盘释放](../cn.zh-CN/.md#)。
...
您可以通过控制台或者调用[ResizeDisk](../cn.zh-CN/API参考/磁盘/ResizeDisk.md#)扩容系统盘。
...
5.  运行`sh test100w.sh`开始测试ESSD云盘性能。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/10111/156471042142181_zh-CN.png)
