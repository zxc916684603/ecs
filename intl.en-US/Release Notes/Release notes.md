...
|-------|:----------|:-----------|----------------|:------------|
|Snapshot|The quota of manual snapshot and automatic snapshot have been lifted to 256 respectively.|September 2, 2019|All|[Snapshot overview](../../../../reseller.en-US/Snapshots/Snapshot overview.md#)|

## June 2019 {#section_qst_fb8_cs .section}

|Feature|Description|Release date|Supported region|Documentation|
|-------|:----------|:-----------|----------------|:------------|
|Redeploy an instance|This feature enables you to redeploy your ECS instance by calling the RedeployInstance operation when the instance receives a system event notification.|June 12, 2019|All|[RedeployInstance](../../../../reseller.en-US/API Reference/Instances/RedeployInstance.md#)|
...
|Feature|Description|Release date|Supported region|Documentation|
|-------|:----------|:-----------|----------------|:------------|
|Elastic Network Interface \(ENI\)|A single ENI supports multiple private IP addresses.|April 28, 2019|All|[Assign a secondary private IP address](../../../../reseller.en-US/Network/Elastic Network Interfaces/Assign a secondary private IP address.md#)|
|Block Storage|System disk resizing is supported.|April 24, 2019|All|[Resize cloud disks offline](../../../../reseller.en-US/Block Storage/Block storage/Resize cloud disks/Resize cloud disks offline.md#)|
|Snapshots|Snapshots of expired disks can be created.|April 20, 2019|All| -   [Create a snapshot](../../../../reseller.en-US/Snapshots/Use snapshots/Create a snapshot.md#)
-   [CreateSnapshot](../../../../reseller.en-US/API Reference/Snapshots/CreateSnapshot.md#)
...
|Reserved instances|The reserved instance feature is released.|March 18, 2019|All|[RI overview](../../../../reseller.en-US/Instances/Instance purchasing options/Reserved Instances/Reserved instance overview.md#)|

## January 2019 {#section_qt_fb8_csy .section}

|Feature|Description|Release date|Supported region|Documentation|
|-------|:----------|:-----------|----------------|:------------|
|Event notifications|Status change events and alert events for recycling preemptible instances are supported.|January 29, 2019|All|[System events](../../../../reseller.en-US/Deployment & Maintenance/System events/System events.md#)|

## December 2018 {#section_st_fb8_csy .section}

|Feature|Description|Release date|Supported region|Documentation|
|-------|:----------|:-----------|----------------|:------------|
|Cloud Assistant|Cloud Assistant supports the UK \(London\) region.|December 31, 2018|All|[Cloud assistant overview](../../../../reseller.en-US/Deployment & Maintenance/Cloud assistant/Cloud assistant overview.md#)|
|Preemptible instances|Preemptible instance bills are accurate to the second.|December 17, 2018|All|[Preemptible instances](../../../../reseller.en-US/Instances/Instance purchasing options/Preemptible instances/Preemptible instances.md#)|
|Instances|Instance release protection is supported.|December 14, 2018|All|[Enable instance release protection](../../../../reseller.en-US/Instances/Manage instances/Enable instance release protection.md#)|
|Elastic Network Interface \(ENI\)|You can call the DescribeNetworkInterfaces API operation to query the public IP address that is attached to an ENI.|December 4, 2018|All|[DescribeNetworkInterfaces](../../../../reseller.en-US/API Reference/Elastic network interfaces/DescribeNetworkInterfaces.md#)|
...
|Block Storage|Subscription disks can be created separately and attached to a subscription instance.|November 29, 2018|All|[Create a subscription disk](../../../../reseller.en-US/Block Storage/Block storage/Create a cloud disk/Create a subscription disk.md#)|
|Deployment set|Alibaba Cloud deployment sets are released.|November 16, 2018|All|[Deployment set](../../../../reseller.en-US/Deployment & Elasticity/Deployment sets/Deployment sets.md#)|
...
-   [CancelSimulatedSystemEvents](../../../../reseller.en-US/API Reference/System event/CancelSimulatedSystemEvents.md#)
 ...
 |
|Billing methods|You can switch the billing method of an instance from subscription to pay-as-you-go.|September 1, 2018|All|[Switch the billing method from subscription to pay-as-you-go.](../../../../reseller.en-US/Pricing/Switch the billing method from Subscription to Pay-As-You-Go.md#)|
...
|Security groups|Security groups in a classic network can be cloned to a VPC in one click.|June 6, 2018|All|[Clone a security group](../../../../reseller.en-US/Security/Security groups/Manage security groups/Manage security groups.md#section_imc_xwy_lgb)|
...
|Feature|Description|Release date|Supported region|Documentation|
|-------|:----------|:-----------|----------------|:------------|
|Custom images|The image compliance tool is released.|May 28, 2018|All|[Image compliance tool](../../../../reseller.en-US/Images/Custom image/Import images/Image compliance tool.md#)|
|System events|ECS system events are migrated to CloudMonitor and can be queried.|May 25, 2018|All|[System events](../../../../reseller.en-US/Deployment & Maintenance/System events/System events.md#)|
|Launch templates|The ECS instance launch template is released.|May 11, 2018|All|[Create a launch template](../../../../reseller.en-US/Deployment & Elasticity/Launch template/Create a launch template.md#)|

## April 2018 {#section_ast_fb8_csy .section}

|Feature|Description|Release date|Supported region|Documentation|
|-------|:----------|:-----------|----------------|:------------|
|Billing methods|You can switch the billing method of an instance from pay-as-you-go to subscription.|April 23, 2018|All|[Switch from Pay-As-You-Go to Subscription billing](../../../../reseller.en-US/Pricing/Switch from Pay-As-You-Go to Subscription billing.md#)|
|Instance upgrade|Subscription ECS instances can be renewed and upgraded or downgraded after expiration.|April 13, 2018|All|[Renew for configuration downgrade](../../../../reseller.en-US/Pricing/Renew instances/Renew for configuration downgrade.md#)|
...
|Feature|Description|Release date|Supported region|Documentation|
|-------|:----------|:-----------|----------------|:------------|
|ECS API operations|The API operation that is used to check whether ECS instances can be upgraded or downgraded is released.|February 10, 2018|All|[DescribeResourcesModification](../../../../reseller.en-US/API Reference/Regions/DescribeResourcesModification.md#)|
|Subscription instances|The number of expiration days of a subscription instance prior to instance release is extended from 7 days to 15 days.|February 7, 2018|All|[Subscription](../../../../reseller.en-US/Pricing/Subscription.md#)|
|ECS API operations|The API operation that is used to create and query resources is released.|February 2, 2018|All|[../../../../dita-oss-bucket/SP\_2/DNA0011860945/EN-US\_TP\_9976.md\#](../../../../reseller.en-US/API Reference/Regions/DescribeAvailableResource.md#)|
...
|ECS API operations|The API operation that is used to create multiple instances at a time is released.|December 1, 2017|All|[RunInstances](../../../../reseller.en-US/API Reference/Instances/RunInstances.md#)|
...
|Feature|Description|Release date|Supported region|Documentation|
|-------|:----------|:-----------|----------------|:------------|
|Server Migration Center|Server Migration Center is released.|November 27, 2017|All|[../../../../dita-oss-bucket/SP\_2/DNA0011894323/EN-US\_TP\_9832.md\#](../../../../reseller.en-US/Migration Service/Cloud Migration tool for P2V and V2V/Cloud Migration tool.md#)|
|Security group rules|Security group rules can be imported and exported.|November 23, 2017|All|[Manage security group rules](../../../../reseller.en-US//Manage security group rules.md#)|
|Subscription instances|Subscription instances can have the auto-renewal function disabled.|November 23, 2017|All|[ModifyInstanceAutoRenewAttribute](../../../../reseller.en-US/API Reference/Instances/ModifyInstanceAutoRenewAttribute.md#)|
|Billing methods|Weekly subscription instances can be created and renewed by calling API operations.|November 3, 2017|All|[CreateInstance](../../../../reseller.en-US/API Reference/Instances/CreateInstance.md#)|
|Instance RAM roles|RAM roles can be assigned to ECS instances.|November 1, 2017|All|[What is the RAM role of an instance](../../../../reseller.en-US/Security/Instance RAM roles/What is the RAM role of an instance.md#)|

## October 2017 {#section_qst_f48_csy .section}

|Feature|Description|Release date|Supported region|Documentation|
|-------|:----------|:-----------|----------------|:------------|
|Elastic IP Address \(EIP\)|The public IP address of an instance in a VPC can be converted to an EIP.|October 31, 2017|All|[Convert an ECS public IP address to an EIP](../../../../reseller.en-US/User Guide/Create an EIP/Convert an ECS public IP address to an EIP.md#)|
|Preemptible instances|Preemptible instances are released.|October 18, 2017|All|[Preemptible instances](../../../../reseller.en-US/Instances/Instance purchasing options/Preemptible instances/Preemptible instances.md#)|
|Burstable performance instances \(t5\)|t5 burstable performance instances are released.|October 9, 2017|All|[Overview](../../../../reseller.en-US/Instances/Instance type families/Burstable performance instances/Overview.md#)|
...
|Feature|Description|Release date|Supported region|Documentation|
|-------|:----------|:-----------|----------------|:------------|
|Security groups|You can isolate instances in a security group by configuring a security group rule.|July 7, 2017|All|[Isolation of instances within a security group](../../../../reseller.en-US/Best Practices/Security/Isolation of instances within a security group.md#)|
...
|Feature|Description|Release date|Supported region|Documentation|
|-------|:----------|:-----------|----------------|:------------|
|SSH key pairs|SSH key pairs are released.|April 25, 2017|All|[SSH key pair overview](../../../../reseller.en-US/Security/Key pairs/SSH key pair overview.md#)|
...
|Snapshots|The system disk snapshot can be used to create data disks.|February 15, 2017|All|[Create a disk by using a snapshot](../../../../reseller.en-US/Block Storage/Block storage/Create a cloud disk/Create a disk from a snapshot.md#)|
...
|Feature|Description|Release date|Supported region|Documentation|
|-------|:----------|:-----------|----------------|:------------|
|Snapshots|Snapshot 2.0 is released.|March 15, 2016|All|[Snapshot overview](../../../../reseller.en-US/Snapshots/Snapshot overview.md#)|
|Disk resizing|The system disk resizing feature is released.|January 15, 2016|All|[Resize cloud disks offline](../../../../reseller.en-US/Block Storage/Block storage/Resize cloud disks/Resize cloud disks offline.md#)|
...
|Tags|The tag feature is released.|August 20, 2015|All|[Tag overview](../../../../reseller.en-US/Tags & Resource Management /Tags/Tag overview.md#)|
