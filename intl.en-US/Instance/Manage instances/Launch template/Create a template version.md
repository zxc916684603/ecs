...
You have already [created a template](reseller.en-US/Instance/Manage instances/Launch template/Create a template.md#).
...
3.  Select a template ID to view its configurations, and then click **New Version**. You can also click **New Version** in the **Actions** column.
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13806/15510235905351_en-US.png)
...
2.  Locate the version you want to set as default, and then click **Set as Default** in the **Actions** column.
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13806/15510235905352_en-US.png)
