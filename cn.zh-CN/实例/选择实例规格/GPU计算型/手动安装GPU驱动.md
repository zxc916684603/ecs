...
2.  手动查找适用于实例的驱动程序，并单击**搜索**。筛选信息说明如下表所示。
 ...
 ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9632/15595308065114_zh-CN.png)
...
3.  按NVIDIA官网GPU驱动下载页的**其他信息**描述安装GPU驱动。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9632/15595308065117_zh-CN.png)
