...
|
|InstanceEventType.N|String|No|One or more instance event types. Value range of N: \[1, 30\], the events must be displayed in the similar format of  `InstanceEventType. 1="Reboot"`, `InstanceEventType. 2="SystemFailure.Reboot"`... Optional values:-   SystemMaintenance.Reboot: Reboot due to system maintenance instance.
...
|InstanceSystemEventSet|Array of [InstanceSystemEventType](#)|Array of the history events of the instance.|
