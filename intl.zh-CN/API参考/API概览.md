...
|接口|描述|
|:-|:-|
|[ZH-CN\_TP\_21439.md\#](intl.zh-CN/API参考/部署集/CreateDeploymentSet.md#)|在指定的地域内创建一个部署集。|
|[ZH-CN\_TP\_21654.md\#](intl.zh-CN/API参考/部署集/ModifyInstanceDeployment.md#)|在同一地域下，修改一台 ECS 实例的宿主机。|
|[ZH-CN\_TP\_21453.md\#](intl.zh-CN/API参考/部署集/ModifyDeploymentSetAttribute.md#)|将一台实例加入一个部署集，或者将实例从一个部署集调整到另外一个部署集。|
|[ZH-CN\_TP\_21454.md\#](intl.zh-CN/API参考/部署集/DescribeDeploymentSets.md#)|查询一个或多个部署集的属性列表。|
|[ZH-CN\_TP\_21452.md\#](intl.zh-CN/API参考/部署集/DeleteDeploymentSet.md#)|删除一个部署集。|
...
|接口|描述|
|:-|:-|
|[CreateCommand](intl.zh-CN/API参考/云助手/CreateCommand.md#)|新建 [../../../../dita-oss-bucket/SP\_2/DNA0011858383/ZH-CN\_TP\_9581.md\#](../../../../intl.zh-CN/运维与监控/云助手/云助手概述.md#) 命令。|
...
|[ModifyCommand](intl.zh-CN/API参考/即将上线/ModifyCommand.md#)|修改已创建的云助手命令相关参数以及命令内容。|

## 标签相关接口 {#section_tag_t2h_vdb .section}

|接口|描述|
|:-|:-|
|[AddTags](intl.zh-CN/API参考/即将上线/AddTags.md#)|添加或者覆盖一个或者多个标签到云服务器 ECS 的各项资源上。|
|[RemoveTags](intl.zh-CN/API参考/即将上线/RemoveTags.md#)|从云服务器 ECS 资源上解绑一个或多个标签，例如，实例、磁盘、快照、镜像和安全组等。|
|[DescribeTags](intl.zh-CN/API参考/即将上线/DescribeTags.md#)|查询可以供您使用的标签。|
