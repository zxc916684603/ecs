...
-   当您给 ECS 实例授予了实例 RAM 角色后，并希望在 ECS 实例内部部署的应用程序中访问云产品的 API 时，您需要通过 [实例元数据](cn.zh-CN/用户指南/实例/实例自定义数据和元数据/实例元数据.md#) 获取实例 RAM 角色的临时授权 Token。参阅 [获取临时授权 Token](#)。
...
4.  在弹窗中：
    ...
    3.  输入角色名称及备注，如 EcsRamRoleDocumentTesting。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9665/15433990705501_zh-CN.png)
...
4.  在弹窗中：
    ...
    2.  输入 **授权策略名称** 及 **策略内容**，如 EcsRamRoleDocumentTestingPolicy。
        ...
        **说明：** 关于如何编写策略内容，您可以参阅 RAM 文档 [Policy 语法结构](../../../../cn.zh-CN//授权策略语言/Policy 语法结构.md#)。

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9665/15433990705502_zh-CN.png)
...
8.  单击符号 **\>** 选中策略名，单击 **确定**。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9665/15433990705503_zh-CN.png)
...
5.  在弹窗中，选择创建好的实例 RAM 角色，如 EcsRamRoleDocumentTesting，单击 **确定** 完成授予。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9665/15433990705504_zh-CN.png)
...
4.  可参阅 [步骤 2：创建ECS实例](../../../../cn.zh-CN/个人版快速入门/步骤 2：创建ECS实例.md#) 设置实例的相关信息，并在 **RAM 角色** 属性中为实例选择已创建好的实例 RAM 角色，如 EcsRamRoleDocumentTesting。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9665/15433990705505_zh-CN.png)
...
5.  **操作类型** 选择 **收回**，单击 **确定** 即可收回实例 RAM 角色。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9665/15433990705506_zh-CN.png)
...
5.  **操作类型** 选择 **授予**，在已有 **RAM 角色** 中选择其他实例 RAM 角色，单击 **确定** 即可更换当前 RAM 角色。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9665/15433990705507_zh-CN.png)
...
2.  检索名为 EcsRamRoleDocumentTesting 的实例 RAM 角色的临时授权 Token：
    ...
    -   Windows 实例：参阅 [实例元数据](cn.zh-CN/用户指南/实例/实例自定义数据和元数据/实例元数据.md#)。
...
其中，\[ECS RAM Action\] 表示可授权 RAM 用户的权限，请参阅 [鉴权规则](../../../../cn.zh-CN/API参考/鉴权规则.md#)。
