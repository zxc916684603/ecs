...
3.  在Linux命令行界面，查看系统版本可以输入命令`# cat /etc/redhat-release`
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9763/154115242021103_zh-CN.png)
...
4.  关闭SELinux
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9763/154115242021065_zh-CN.png)
...
5.  安全组设置
    ...
    2.  点击左侧导航栏中的**实例**。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9763/154115242021095_zh-CN.png)

    3.  在**实例列表**中找到要设置安全组的实例并点击实例的ID。
    4.  点击左侧导航栏中的**本实例安全组**。

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9763/154115242021096_zh-CN.png)

    5.  点击**配置规则**。

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9763/154115242021144_zh-CN.png)

    6.  点击**添加安全组规则**。

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9763/154115242021145_zh-CN.png)

    7.  [添加安全组规则](../cn.zh-CN/用户指南/安全组/添加安全组规则.md#)。

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9763/154115242021146_zh-CN.png)
...
7.  登录 [ECS管理控制台](https://ecs.console.aliyun.com/)，点击左侧导航栏中的**实例**，在**实例列表**中找到正在部署环境的实例，从这个实例的**IP地址**项中复制它的公网IP，用浏览器访问这个IP地址可看到默认欢迎页面。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9763/154115242021168_zh-CN.png)
...
7.  添加nginx对fastcgi的支持，首先备份默认的配置文件。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9763/154115242021386_zh-CN.png)
