...
2.  关闭防火墙。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/64105/154391313132172_zh-CN.png)
...
5.  运行`java -version`命令，显示JDK版本信息时，表示 JDK 已经安装成功。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9766/154391313130641_zh-CN.png)
...
7.  在浏览器地址栏中输入`http://公网IP:8080`进行访问。出现下图所示页面时表示安装成功。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9766/154391313112137_zh-CN.png)
