# Xen/KVM/Hyper-V迁移至阿里云 {#concept_gls_c55_fgb .concept}

您可以参考本文档中的步骤，将Xen/KVM/Hyper-V虚拟机迁移至阿里云ECS实例。
...
## Linux系统迁移至阿里云 {#section_jn1_qzp_pgb .section}
...
4.  等待迁云工具运行完成。当运行迁云工具的界面上提示Go to Aliyun Finished!时，表示迁移完成。如下图所示。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/65301/154875444038196_zh-CN.png)
