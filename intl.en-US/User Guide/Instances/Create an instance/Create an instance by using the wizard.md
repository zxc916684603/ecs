...
5.  Click **Next: Networking** to finish the network and security group configuration: 
    ...
    2.  Configure the Internet bandwidth: 
        ...
        -   If your instances do not need to access the Internet or your VPC instances [use an Elastic IP \(EIP\) address to access the Internet](../../../../intl.en-US/Quick Start/Create a VPC.md#), you do not need to assign a public IP. You can unbind an EIP address from an instance.
