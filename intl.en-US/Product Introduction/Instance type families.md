...
|Instance type|vCPU|Memory \(GiB\) |Memory \(GiB\)[\*](#localdisk)|GPU|Bandwidth \(Gbit/s\) |Packet forwarding rate \(Thousand pps\)[\*\*](#pps)|NIC queues[\*\*\*](#queue)|ENIs[\*\*\*\*](#eni)|
|:------------|:---|:--------------|:-----------------------------|:--|:--------------------|:--------------------------------------------------|:-------------------------|:-------------------|
