...
Phased-out instance types including c1, c2, m1, m2, s1, s2, s3, and t1 do not support system events. For more information, see [Instance type families](../reseller.en-US/Product Introduction/Instance type families.md#).
...
|Avoided|Stable status|You have taken the actions in advance within the [user operation period](reseller.en-US/User Guide/Monitoring/System events.md#ul_ynp_5yz_xdb).|
...
-   System action period: Generally, if you wait until we take the default action, system events are automatically fixed within 6 hours after the system action period begins at a scheduled time. Later you receive the report of system events.
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9748/15405406093942_en-US.png)
