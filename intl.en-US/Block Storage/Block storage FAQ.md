...
## Can I specify the disk performance attribute of an ESSD cloud disk? {#section_ix8_45l_h4m .section}

Yes, when you purchase an ESSD cloud disk, you can select a specific disk performance output for that disk. If you require a different disk performance attribute after you purchase the ESSD cloud disk, you can modify the disk performance attribute on the disk details page of the ECS console or by calling ModifyDiskAttribute.
...
5.  Run `sh test100w.sh` to start testing the performance of the ESSD disk.
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/10111/155966902142181_en-US.png)
