...
Creates a custom image. You can use a custom image to create instances \([RunInstances](intl.en-US/API Reference/Instances/RunInstances.md#)\) or change the system disk for an existing instance \([ReplaceSystemDisk](intl.en-US/API Reference/Disk/ReplaceSystemDisk.md#)\).
...
|RegionId|String|Yes|The region ID of the image. For more information, call [DescribeRegions](../intl.en-US/API Reference/Regions/DescribeRegions.md#) to obtain the latest region list.|
