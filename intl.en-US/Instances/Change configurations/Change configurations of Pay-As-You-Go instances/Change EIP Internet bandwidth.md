...
6.  On the Confirm Order page, set the new peak bandwidth.
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9646/15564464445429_en-US.png)
...
-   Use the [Upgrade Configuration](reseller.en-US/Instances/Change configurations/Upgrade configurations/Upgrade configurations of Subscription instances.md#) feature to change the Internet bandwidth immediately.
