...
如果您对阿里云的OpenAPI非常熟悉，您可以参见[弹性管理ECS实例](../../../../cn.zh-CN/SDK示例/SDK使用案例/弹性管理ECS实例.md#)，通过OpenAPI进行批量操作。对应的Python片段如下。
...
您也可以通过为安全组设置标签分组管理自己的安全组。您可以在控制台直接设置标签，具体操作请参见[设置标签](../../../../cn.zh-CN/标签与资源/标签/绑定标签.md#)，也可以通过API设置标签。
