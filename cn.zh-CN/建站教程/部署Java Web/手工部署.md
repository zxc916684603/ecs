...
5.  在网站根目录下新建 Tomcat 测试页面，然后将网站根目录下文件权限改为 www：
...
5.  运行 \# java -version命令，显示JDK版本信息时，表示 JDK 已经安装成功。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9766/154227637230641_zh-CN.png)
...
7.  在浏览器地址栏中输入 http://公网IP:8080 进行访问。出现下图所示页面时表示安装成功。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9766/154227637212137_zh-CN.png)
